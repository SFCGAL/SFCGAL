 ...
 * @param allowHoles whether to allow holes in the result (default: false)
 * @return the computed alpha shapes as a unique_ptr<Geometry>
 * @since 1.4.1
 */
SFCGAL_API auto
alphaShapes(const Geometry &geometry, double alpha = 1, bool allowHoles = false)
 ...
 * @param geometry the input geometry
 * @param allowHoles whether to allow holes in the result (default: false)
 * @param nbComponents the number of components (default: 1)
 * @return the computed optimal alpha shapes as a unique_ptr<Geometry>
 * @since 1.4.1
 */
SFCGAL_API auto
optimalAlphaShapes(const Geometry &geometry, bool allowHoles = false,
                   size_t nbComponents = 1) -> std::unique_ptr<Geometry>;
